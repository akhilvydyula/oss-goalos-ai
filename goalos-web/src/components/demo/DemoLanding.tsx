...
export function DemoLanding() {
  return (
    <div className="goalos-page-bg relative flex min-h-dvh flex-col">
      <AmbientScene3D className="opacity-45" />
      <div className="relative z-10 mx-auto w-full max-w-5xl flex-1 px-5 py-10 sm:px-8 sm:py-14">
        ...
        <p className="mx-auto mt-4 max-w-lg text-center text-sm leading-relaxed text-zinc-400 sm:text-base">
          Open-source productivity OS with AI coaching and WebGL dashboards. Watch the walkthrough,
          browse screenshots, or jump into a live demo.
        </p>
